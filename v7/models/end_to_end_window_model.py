...
def create_end_to_end_model(
    ...
    use_tcn : bool, optional
        If True, use Temporal Convolutional Network (TCN) for feature extraction
        instead of standard linear layers. Default is False.

    tcn_channels : int, optional
        Number of channels in TCN layers. Default is 64.

    tcn_kernel_size : int, optional
        Kernel size for TCN convolutions. Default is 3.

    tcn_layers : int, optional
        Number of TCN layers. Default is 2.
