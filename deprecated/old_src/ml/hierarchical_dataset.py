                        ...
                        if tf in self.tf_timestamps:
                            ...
                            if tf == 'daily' and row_idx is None:
                                ...
                                if self._daily_lookup_debug_count <= 3:
                                    ...
                                    print(f"[DEBUG] Daily lookup FAILED: tf_ts={tf_ts}, int(tf_ts)={int(tf_ts)}")
                                    print(f"[DEBUG]   Dict sample keys: {dict_keys}")
                                    print(f"[DEBUG]   ts_5min={ts_5min}, tf_idx={tf_idx}")
                        ...
                        if tf == 'daily':
                            ...
                            if best_confidence > 0.0:
                                ...
                                if self._daily_valid_debug_count <= 3:
                                    print(f"[DEBUG] Daily VALID: row_idx={row_idx}, best_conf={best_confidence:.3f}, best_dur={best_duration:.1f}")
                            else:
                                self._daily_invalid_window_count += 1
                                if self._daily_invalid_window_count <= 3:
                                    print(f"[DEBUG] Daily row found but NO valid windows: row_idx={row_idx}")
