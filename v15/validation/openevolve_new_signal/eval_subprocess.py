#!/usr/bin/env python3
"""
Subprocess evaluator wrapper for Phase B2: new cross-asset signal evolution.

Runs in a fresh process per evaluation to prevent memory leaks.
...
from v15.validation.openevolve_new_signal.evaluator import evaluate
