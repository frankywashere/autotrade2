#!/usr/bin/env python3
"""
Subprocess evaluator wrapper for Phase B3: channel break predictor evolution.

Runs in a fresh process per evaluation to prevent memory leaks from
loading 3.3M-row 5-sec bar data + channel detection overhead.
...
from v15.validation.openevolve_channel_break.evaluator import evaluate
