...
def run_year_backtest(year_data, year, capital, vix_df, signal_quality_model=None, ml_size_fn=None,
                      bounce_cap=4.0, max_trade_usd=500_000.0):
...
def main():
    ...
    parser.add_argument('--bounce-cap', type=float, default=4.0,
                        help='Max exposure cap multiplier for bounce signals (default: 4.0)')
