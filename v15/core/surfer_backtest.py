                ...
                if defer_entry:
                    ...
                    if realistic:
                        ...
                        if sig.signal_type == 'bounce':
                            ...
                            elif _tod_h == 15:  # 10am ET: $373/trade avg (2015+2025), 1.25x (Arch391: up from 1.20x, matches 11am tier)
                                trade_size *= 1.25
                            ...
                            elif _tod_h == 18:  # 1pm ET: $595/trade avg (2025), 1.40x (Arch390: up from 1.35x)
                                trade_size *= 1.40
                            ...
                            elif _tod_h == 21:  # 4pm ET: $388/trade avg, 1.20x (Arch395: new hour, after-hours, 49 trades/yr)
                                trade_size *= 1.20
                        ...
                        if sig.signal_type == 'bounce':
                            ...
                            elif _dow == 1:  # Tuesday: 1.15x (Arch394: up from 1.10x, step toward Wed/Fri ×1.20)
                                trade_size *= 1.15
