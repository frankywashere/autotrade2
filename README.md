...
# Extract features (same 379 features as training)
...
- **220** channel features (11 timeframes × 10 metrics × 2 stocks)
...
### Feature Engineering
- `src/ml/features.py` - Rolling channel detection + all 379 features (multi-threshold ping-pongs)
